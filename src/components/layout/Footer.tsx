...
export function Footer() {
  ...
  const services = [
    { name: 'Find Barbers', href: '/services/barbers' },
    { name: 'Hair Stylists', href: '/services/stylists' },
    { name: 'Beauty Salons', href: '/services/salons' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center mb-4">
              <Image
                ...
                className="h-10 w-10"
              />
              <span className="ml-2 text-xl font-bold">Barberng</span>
            </Link>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">123 Beauty Street, Style City, SC 12345</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@barberng.com</span>
              </div>
            </div>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  ...
                  >
                    <ChevronRightIcon className="h-4 w-4 mr-1 transform group-hover:translate-x-1 transition-transform" />
                    {link.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-gray-300">Get the best experience with our mobile app</p>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Barberng. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="/accessibility" className="text-gray-400 hover:text-primary-400 text-sm transition-colors">
              Accessibility
            </Link>
          </div>
        </div>
